...
set lins [insource {Usien\|Usien/} $argv]
...
#set old1 {]</span> - [[}
#set new1 {] - [[}
set old1 {[[Benutzer:Usien|Usien<big><span style="color: #FF0000">  Max</span>]]</big>}
set new1 {[[Benutzer:Usien|Usien<span style="color: #FF0000; font-size: 120%;"> Max</span>]]}
...
#	set nin [string map [list $old1 $new1 $old2 $new2 $old3 $new3 $old4 $new4 $old5 $new5 $old6 $new6 $old7 $new7 $old8 $new8] $in]
#	set nin [string map [list $old1 $new1 $old2 $new2 $old3 $new3 $old4 $new4 $old5 $new5 $old6 $new6 $old7 $new7 $old8 $new8 $old9 $new9 $old10 $new10 $old11 $new11 $old12 $new12 $old13 $new13 $old14 $new14 $old15 $new15 $old16 $new16 $old17 $new17] $in]
