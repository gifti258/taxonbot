...
set lpt [insource {references responsive=\"\"/} 0]



foreach pt [lsort -unique $lpt] {catch {

set c [conts t $pt x]
set match {references responsive=""}
if {[string first $match $c] > -1} {
	set c [string map [list $match {references responsive}] $c]
	puts \n$pt:\n[edit $pt {Bot: Korrektur der Wiki-Syntax nach [[phabricator:T101841]]} $c / minor]
}
