...
set elist [list \u007f {} \u00a0 {} \u2004 {} \u2005 {} \u2006 {} \u2007 {} \u2008 {} \u200b {} \u200e {} \u200f {} \u2028 {} \u202a {} \u202c {} \u202d {} \ufeff {}]
set clist [list " \u007f " { } " \u00a0 " { } " \u2004 " { } " \u2005 " { } " \u2006 " { } " \u2007 " { } " \u2008 " { } " \u200b " { } " \u200e " { } " \u200f " { } " \u2028 " { } " \u202a " { } " \u202c " { } " \u202d " { } " \ufeff " { }]
set wurgl [conts id 10726882 12]
puts $wurgl
set ll [dict values [regexp -all -inline -- {\[\{\{fullurl:(.*?)\|} $wurgl]]
puts $ll
#set csv [getHTML https://tools.wmflabs.org/persondata/vorlagen/?value=%25_%C2%A0_%25&value_op=lk&show_tmpl&show_occ&show_param&show_value&export=1]
#foreach line [split $csv \n] {
#	set mline [string map [list \"\; _] [regsub -- {"} $line _]]
#	lappend lpt [lindex [split $mline _] 1]
#}
#puts $lpt
#set lpt [lsort -unique [lrange $lpt 1 end-1]]
#set lpt [lrange $lpt 2 end]
...
foreach pt $ll {
puts $pt
	if [catch {set c [conts2 t $pt x]}] {continue}
