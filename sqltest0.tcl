...
set oe {{| Öhringen, [[Landkreis Öhringen|Land]][[Oberamt Öhringen|''kreis'']]
| align=center | ÖHR
| align=center | ÖHR
| align=center | 
| align=center | ÖHR
...
| align=center | 
| align=center | 
| align=center | KÜN, ÖHR
}}

set ue {{| Überlingen, [[Landkreis Überlingen|Landkreis]]
| align=center | ÜB
| align=center | ÜB
| align=center | 
| align=center | ÜB
...
set ekreis {Amberg Ansbach Aschaffenburg Bremerhaven Cottbus Delmenhorst Erlangen {{Frankfurt (Oder)}} {{Hof (Saale)}} Kiel München Rheydt Rosenheim Schwerin Straubing Wanne-Eickel {Wattenscheid Bochum} {{Weiden in der Oberpfalz}} Wesermünde Wilhelmshaven Augsburg Baden-Baden Bamberg Bayreuth Berlin Bielefeld Bochum Bonn Bottrop {{Brandenburg an der Havel}} Braunschweig Bremen Chemnitz Coburg Darmstadt Dessau Dortmund Dresden Duisburg Düsseldorf Eisenach Emden Erfurt Essen Flensburg {{Frankenthal (Pfalz)}} {{Frankfurt am Main}} {Frankfurt-Höchst {Frankfurt am Main}} {{Freiburg im Breisgau}} Fürth Gelsenkirchen Gera Hagen {Halle-Neustadt {Halle (Saale)}} Hamburg Hamm Heidelberg Heilbronn {Heiligenbeil Mamonowo} Herne Ingolstadt Jena Kaiserslautern Karlsruhe Kaufbeuren {{Kempten (Allgäu}} Koblenz Krefeld Köln {{Königsberg (Preußen)} Kaliningrad} {{Landau in der Pfalz}} Landshut Leipzig Leverkusen {{Ludwigshafen am Rhein}} Lübeck Magdeburg Mainz Mannheim Memmingen Mönchengladbach {{Mülheim an der Ruhr}} Münster {{Neustadt an der Weinstraße}} Nürnberg Oberhausen {{Offenbach am Main}} {{Oldenburg (Oldb)}} {Opladen Leverkusen} Osnabrück Passau Pforzheim Pirmasens Potsdam Regensburg Rostock {Rostock-Land Rostock} {Roßlau Dessau-Roßlau} Salzgitter Schwabach Schweinfurt Solingen Speyer Stuttgart Suhl {Tilsit {Sowetsk (Kaliningrad)}} Trier Ulm Weimar Wiesbaden Wolfsburg Worms}
set nekreis {Amberg Ansbach Aschaffenburg Bremerhaven Cottbus Delmenhorst Erlangen {Frankfurt (Oder)} {Hof (Saale)} Kiel München Rheydt Rosenheim Schwerin Straubing Wanne-Eickel Wattenscheid {Weiden in der Oberpfalz} Wesermünde Wilhelmshaven Augsburg Baden-Baden Bamberg Bayreuth Berlin Bielefeld Bochum Bonn Bottrop {Brandenburg an der Havel} Braunschweig Bremen Chemnitz Coburg Darmstadt Dessau Dortmund Dresden Duisburg Düsseldorf Eisenach Emden Erfurt Essen Flensburg {Frankenthal (Pfalz)} {Frankfurt am Main} Frankfurt-Höchst {Freiburg im Breisgau} Fürth Gelsenkirchen Gera Hagen Halle-Neustadt Hamburg Hamm Heidelberg Heilbronn Heiligenbeil Herne Ingolstadt Jena Kaiserslautern Karlsruhe Kaufbeuren {Kempten (Allgäu} Koblenz Krefeld Köln {Königsberg (Preußen)} {Landau in der Pfalz} Landshut Leipzig Leverkusen {Ludwigshafen am Rhein} Lübeck Magdeburg Mainz Mannheim Memmingen Mönchengladbach {Mülheim an der Ruhr} Münster {Neustadt an der Weinstraße} Nürnberg Oberhausen {Offenbach am Main} {Oldenburg (Oldb)} Opladen Osnabrück Passau Pforzheim Pirmasens Potsdam Regensburg Rostock Rostock-Land Roßlau Salzgitter Schwabach Schweinfurt Solingen Speyer Stuttgart Suhl Tilsit Trier Ulm Weimar Wiesbaden Wolfsburg Worms}
...
#	puts $nr
	...
	set nlk [join $nlk {, }]
#	puts $nlk
	lassign {} kfz kreis powiat skreis spowiat rajon
	set no $o
	switch $o {
		...
		{Bartenstein (Ostpreußen)}	{set no  Bartoszyce}
		 Belgard							{set no  Bia%C5%82ogard}
		...
		Biberach {set no {Biberach an der Riß}}
Birkenfeld {set no {Birkenfeld (Nahe)}}
Bitterfeld {set no Bitterfeld-Wolfen}
Blankenburg {set no Braunlage}
Bogen {set no {Bogen (Stadt)}}
Bomst {set no Babimost}
Borna/Sachsen {set no Borna}
Braunsberg {set no Braniewo}
Buchen {set no {Buchen (Odenwald)}}
Bunzlau {set no Boles%C5%82awiec}
Burg {set no {Burg (bei Magdeburg)}}
Burgdorf {set no {Burgdorf (Region Hannover)}}
Bühl {set no {Bühl (Baden)}}
Büren {set no {Büren (Westfalen)}}
{Calbe an der Saale} {set no {Calbe (Saale)}}
{Cammin in Pommern} {set no {Kamie%C5%84 Pomorski}}
Cham {set no {Cham (Oberpfalz)}}
Cosel {set no K%C4%99dzierzyn-Ko%C5%BAle}
Dessau {set no Dessau-Roßlau}
Dramburg {set no {Drawsko Pomorskie}}
Ehingen {set no {Ehingen (Donau)}}
{Eisenberg (Bezirk Gera)} {set no {Eisenberg (Thüringen)}}
Erbach {set no {Erbach (Odenwald)}}
{Falkenberg Oberschlesien} {set no Niemodlin}
Fischhausen {set no {Primorsk (Kaliningrad)}}
Flatow {set no Z%C5%82ot%C3%B3w}
Forst {set no {Forst (Lausitz)}}
Frankenberg {set no {Frankenberg (Eder)}}
Frankenstein {set no {Z%C4%85bkowice %C5%9Al%C4%85skie}}
Frankfurt-Höchst {set no {Frankfurt am Main}}
Franzburg-Barth {set no Franzburg}
{Freystadt in Niederschlesien} {set no Ko%C5%BCuch%C3%B3w}
{Friedeberg Neumark} {set no {Strzelce Kraje%C5%84skie}}
Fritzlar-Homberg {set no Fritzlar}
Fürstenwalde {set no Fürstenwalde/Spree}
Gandersheim {set no {Bad Gandersheim}}
Gerdauen {set no {Schelesnodoroschny (Kaliningrad)}}
Goldberg {set no Z%C5%82otoryja}
Grafenau {set no {Grafenau (Niederbayern)}}
Greifenhagen {set no Gryfino}
{Griesbach im Rottal} {set no {Bad Griesbach im Rottal}}
Grottkau {set no Grodk%C3%B3w}
Halle-Neustadt {set no {Halle (Saale)}}
Heiligenstadt {set no {Heilbad Heiligenstadt}}
Heilsberg {set no {Lidzbark Warmi%C5%84ski}}
Hersfeld {set no {Bad Hersfeld}}
Herzberg {set no {Herzberg (Elster)}}
{Hindenburg Oberschlesien} {set no Zabrze}
Hochschwarzwald {set no Titisee-Neustadt}
Jauer {set no Jawor}
Jessen {set no {Jessen (Elster)}}
Johannisburg {set no Pisz}
Kempen-Krefeld {set no Kempen}
Kolberg {set no Ko%C5%82obrzeg}
{Kreuzburg Oberschlesien} {set no Kluczbork}
Krumbach {set no {Krumbach (Schwaben)}}
{Königsberg (Preußen)} {set no Kaliningrad}
{Königsberg Neumark} {set no Chojna}
{Königshofen im Grabfeld} {set no {Bad Königshofen im Grabfeld}}
Königshütte {set no Chorz%C3%B3w}
Laufen {set no {Laufen (Salzach)}}
Lauterbach {set no {Lauterbach (Hessen)}}
Leer {set no {Leer (Ostfriesland)}}
Lichtenfels {set no {Lichtenfels (Oberfranken)}}
Limburg {set no {Limburg an der Lahn}}
Lobenstein {set no {Bad Lobenstein}}
Lyck {set no E%C5%82k}
Lötzen {set no Gi%C5%BCycko}
Lüben {set no Lubin}
Mahlow {set no Blankenfelde-Mahlow}
Mallersdorf {set no Mallersdorf-Pfaffenberg}
Marienwerder {set no Kwidzyn}
Meseritz {set no Mi%C4%99dzyrzecz}
Mühlhausen {set no Mühlhausen/Thüringen}
Müllheim {set no {Müllheim (Baden)}}
Münsingen {set no {Münsingen (Württemberg)}}
Naugard {set no Nowogard}
Naumburg {set no {Naumburg (Saale)}}
Nebra {set no {Nebra (Unstrut)}}
Neisse {set no Nysa}
Neuhaus {set no {Neuhaus am Rennweg}}
Neumarkt {set no {%C5%9Aroda %C5%9Al%C4%85ska}}
Niederung {set no Slawsk}
Nienburg {set no Nienburg/Weser}
Norden {set no {Norden (Ostfriesland)}}
Obernburg {set no {Obernburg am Main}}
Oels {set no Ole%C5%9Bnica}
Oelsnitz {set no Oelsnitz/Vogtl.}
Ohlau {set no O%C5%82awa}
Osterburg {set no {Osterburg (Altmark)}}
Osterholz {set no Osterholz-Scharmbeck}
Pegnitz {set no {Pegnitz (Stadt)}}
Pillkallen {set no Dobrowolsk}
Pyritz {set no Pyrzyce}
Randow {set no Löcknitz}
Ratibor {set no Racib%C3%B3rz}
Regen {set no {Regen (Stadt)}}
Reichenbach {set no {Reichenbach im Vogtland}}
{Reichenbach (Eulengebirge)} {set no Dzier%C5%BConi%C3%B3w}
Reppen {set no Rzepin}
{Rosenberg Oberschlesien} {set no Olesno}
Rostock-Land {set no Rostock}
{Rotenburg (Fulda)} {set no {Rotenburg an der Fulda}}
{Rothenburg (Oberlausitz)} {set no Rothenburg/Oberlausitz}
Roßlau {set no Dessau-Roßlau}
{Rummelsburg in Pommern} {set no Miastko}
Rügen {set no {Bergen auf Rügen}}
Saatzig {set no Stargard}
Sagan {set no %C5%BBaga%C5%84}
Salzbrunn {set no Szczawno-Zdr%C3%B3j}
{Schlawe in Pommern} {set no S%C5%82awno}
Schwarzenberg {set no Schwarzenberg/Erzgeb.}
{Schwerin (Warthe)} {set no Skwierzyna}
Schönberg {set no {Schönberg (Mecklenburg)}}
Schönebeck {set no {Schönebeck (Elbe)}}
Segeberg {set no {Bad Segeberg}}
Sensburg {set no Mr%C4%85gowo}
Simmern {set no Simmern/Hunsrück}
{Spremberg (Lausitz)} {set no Spremberg}
Stollberg {set no Stollberg/Erzgeb.}
Strasburg {set no {Strasburg (Uckermark)}}
Strehlen {set no Strzelin}
Stuhm {set no Sztum}
Tilsit {set no {Sowetsk (Kaliningrad)}}
Trebnitz {set no Trzebnica}
Usedom-Wollin {set no {Usedom (Stadt)}}
Vaihingen {set no {Vaihingen an der Enz}}
Villingen {set no Villingen-Schwenningen}
Waldenburg {set no Wa%C5%82brzych}
Wangen {set no {Wangen im Allgäu}}
Wanzleben {set no Wanzleben-Börde}
Waren {set no {Waren (Müritz)}}
Wasserburg {set no {Wasserburg am Inn}}
Wehlau {set no {Snamensk (Kaliningrad)}}
Weilheim {set no {Weilheim in Oberbayern}}
Weißensee {set no {Weißensee (Thüringen)}}
Wesermünde {set no Bremerhaven}
Wiedenbrück {set no Rheda-Wiedenbrück}
Wittlage {set no {Bad Essen}}
Wittstock {set no Wittstock/Dosse}
Wohlau {set no Wo%C5%82%C3%B3w}
Worbis {set no Leinefelde-Worbis}
Zell {set no {Zell (Mosel)}}
Zeulenroda {set no Zeulenroda-Triebes}
Ziegenhain {set no Schwalmstadt}
Züllichau-Schwiebus {set no Sulech%C3%B3w}
	}
	set htmlconts [getHTML https://de.wikipedia.org/wiki/[string map {{ } _} $no]]
	regexp -- {Kfz-Kennzeichen.*?\n<td.*?>(.*?)</td>} $htmlconts -- kfz
	regexp -- {reis</a>.*?\n<td.*?>.*?/wiki/(.*?)"} $htmlconts -- kreis
	switch $o {
		Zweibrücken {set kreis Landkreis_Zweibr%C3%BCcken}
		Wehlau		{set rajon Rajon_Gwardeisk}
		Waldeck		{set kreis Landkreis_Waldeck-Frankenberg}
		Stallupönen {set rajon Rajon_Nesterow}
		{Preußisch Eylau} {set rajon Rajon_Bagrationowsk}
		Pillkallen	{set rajon Rajon_Krasnosnamensk}
		Pfarrkirchen {set kreis Landkreis_Rottal-Inn}
		Niederung	{set rajon Rajon_Slawsk}
		Lüchow-Dannenberg {set kreis Landkreis_Lüchow-Dannenberg}
		Labiau		{set rajon Rajon_Polessk}
		Insterburg	{set rajon Rajon_Tschernjachowsk}
		Gumbinnen	{set rajon Rajon_Gussew}
		Gerdauen		{set rajon Rajon_Prawdinsk}
		Fischhausen {set rajon Rajon_Baltijsk}
		Darkehmen	{set rajon Rajon_Osjorsk}
	}
	regexp -- {Powiat</a>.*?\n<td.*?>(.*?)</td>} $htmlconts -- powiat
#	puts "-- kreis: $kreis"
#	puts "-- powiat: $powiat"
	if {[empty kreis] && [empty powiat]} {lappend ekreis $o}
	if ![empty powiat] {regexp -- {/wiki/(.*?)"} $powiat -- spowiat}
	if {$powiat eq {Kreisfreie Stadt}} {set spowiat {Kreisfreie Stadt}}
#	puts "-- spowiat: $spowiat"
#	puts "-- rajon: $rajon"
#	puts "-- kfz: $kfz"
	...
	foreach kr $ekreis {
		if {$o eq [lindex $kr 0]} {
			switch $o {
				Berlin			{set kfz B ; lappend kfz3 "$o: [join $kfz]" ; break}
				Dessau			{set kfz {DE, RSL} ; lappend kfz3 "$o: [join $kfz]" ; break}
				Opladen			{set kfz {LEV, OP} ; lappend kfz3 "$o: [join $kfz]" ; break}
				Rheydt			{set kfz MG ; lappend kfz3 "$o: [join $kfz]" ; break}
				Wanne-Eickel	{set kfz {HER, WAN} ; lappend kfz3 "$o: [join $kfz]" ; break}
				Wattenscheid	{set kfz {BO, WAT} ; lappend kfz3 "$o: [join $kfz]" ; break}
				Wesermünde		{set kfz HB ; lappend kfz3 "$o: [join $kfz]" ; break}
			}
			if {[llength $kr] == 2} {set nkr [lindex $kr 1]} else {set nkr $kr}
#			puts $nkr
			set htmlconts [getHTML https://de.wikipedia.org/wiki/[string map {{ } _} [join $nkr]]]
			regexp -- {Kfz-Kennzeichen.*?\n<td.*?>(.*?)</td>} $htmlconts -- kfz2
			lappend kfz $kfz2
#			lappend kfz3 "$o: [join $kfz]"
			break
		}
	}
	if {$o ni $nekreis} {
		if ![empty rajon] {
			set htmlconts [getHTML https://de.wikipedia.org/wiki/[string map {{ } _} [join $rajon]]]
			regexp -- {Kfz-Kennzeichen.*?\n<td.*?>(.*?)</td>} $htmlconts -- kfz2
			lappend kfz $kfz2
#			lappend kfz3 "$o: [join $kfz]"
		} elseif ![empty spowiat] {
			set htmlconts [getHTML https://de.wikipedia.org/wiki/[string map {{ } _} [join $spowiat]]]
			regexp -- {Kfz-Kennzeichen.*?\n<td.*?>(.*?)</td>} $htmlconts -- kfz2
			lappend kfz [regsub -all -- {</?code>} $kfz2 {}]
			set kfz [regsub -all -- {\(.*?\)} $kfz {}]
			if {$o eq {Posen}} {set kfz {PO, PY}}
#			lappend kfz3 "$o: [join $kfz]"
		} else {
			set htmlconts [getHTML https://de.wikipedia.org/wiki/[string map {{ } _} [join $kreis]]]
			regexp -- {Kfz-Kennzeichen.*?\n<td.*?>(.*?)</td>} $htmlconts -- kfz2
			lappend kfz $kfz2
			set kfz [regsub -all {<.*?>} $kfz {}]
			set kfz [string map {( {} ) {} {Vorlage:Infobox Verwaltungseinheit in Deutschland/Wartung/Kfz enthält Kleinbuchstaben} {}} $kfz]
		}
	}
	if {![empty spowiat] || ![empty rajon] || $o in {Tilsit {Königsberg (Preußen)} Heiligenbeil}} {
		set l00 {}
		foreach 1 [string trim [string map {, {}} [join $kfz]]] {
			lappend l00 ''$1''
		}
		lappend lr [list 00 $l00]
	} else {
		lappend lr [list 00 [string trim [string map {, {}} [join $kfz]]]]
	}
	puts $lr



lassign {} nr k 50 51 53 56 57 590 790 91 00
foreach r $lr {
	dict with r {
		set a0 [string index $o 0]
#		dict lappend nr a [string index $o 0]
		dict lappend nr k $k
		catch {dict lappend nr 50 $50}
		catch {dict lappend nr 51 $51}
		catch {dict lappend nr 53 $53}
		catch {dict lappend nr 56 $56}
		catch {dict lappend nr 57 $57}
		catch {dict lappend nr 590 $590}
		catch {dict lappend nr 790 $790}
		catch {dict lappend nr 91 $91}
		catch {dict lappend nr 00 $00}
	}
}
...
foreach {i r} $nr {
	if {$i eq {k}} {
		if {$o in {Zerbst Zeitz Wittenberg Wismar Weißenfels Suhl Stendal Schönebeck Salzwedel Rathenow Quedlinburg Nordhausen Neubrandenburg Merseburg}} {
			set r [lindex $r 1]
			puts "$i $r"
			lappend ntr "$o, [join $r]"
		} elseif {$o in {Köthen Halberstadt Güstrow Guben Greiz Greifswald Gotha Eisleben Eisenach Eberswalde Burg Bernburg Aschersleben Arnstadt Apolda Altenburg}} {
			set r [lindex $r 0]
			puts "$i $r"
			lappend ntr "$o, [join $r]"
		} else {
		  	puts "$i [lsort -unique $r]"
		  	lappend ntr "$o, [join [lsort -unique $r]]"
		}
	} elseif {$i eq {00}} {
		puts "$i [join [lsort -unique [join $r]] {, }]"
		lappend ntr "align=center | [join [lsort -unique [join $r]] {, }]"
	} else {
	  	puts "$i [join [lsort -unique [join $r]] {, }]"
		lappend ntr "align=center | [join [lsort -unique [join $r]] {, }]"
	}
...
if {$a eq $a0} {
	if {$a0 eq {O} && ![exists oe1]} {
		set lntr {}
		lappend lntr Ohringen [join $oe]
		incr oe1
	}
	if {$a0 eq {U} && ![exists ue1]} {
		set lntr {}
		lappend lntr Uberlingen [join $ue]
		incr ue1
	}
	lappend lntr [string map {ä a ö o ü u Ö O Ü U} $o] "| $ntr"
} else {
#	lassign {} ixntr ixlntr
	set ixlntr [lsort -stride 2 -index 0 $lntr]
	set lntr $th
	foreach {-- ixntr} $ixlntr {lappend lntr $ixntr}
	puts $lntr
#	foreach 1 $lntr {
#		regexp -- {^(.*?),} $1 -- ixntr
#		lappend ixlntr $ixntr $lntr
#	}
#	puts $ixlntr
	if {$a ni {Ö Ü}} {
		append ncont "\n== $a ==\n\{[join $lntr "\n|-\n"]\n|\}\n"
...
puts [edit {Benutzer:Thomas021071/Liste der Kfz-Kennzeichen der BRD 2010} {Bot: neue KFZ-Listen} [string map [list ")\n== A" ")\n\n$ncont\n\n== A"] [conts t {Benutzer:Thomas021071/Liste der Kfz-Kennzeichen der BRD 2010} x]]]
...
foreach kr $ekreis {
	...
	if {$kr in $nekreis} {
		set kfz2 {}
		set htmlconts [getHTML https://de.wikipedia.org/wiki/[string map {{ } _} $nkr]]
		regexp -- {Kfz-Kennzeichen.*?\n<td.*?>(.*?)</td>} $htmlconts -- kfz2
		puts "$kr: $kfz2"
	}
}
...
set ekreis [string map {{Frankfurt (Oder)} {{Frankfurt (Oder)}} {Hof (Saale)} {{Hof (Saale)}} {Weiden in der Oberpfalz} {{Weiden in der Oberpfalz}} Wattenscheid {{Wattenscheid Bochum}}} $ekreis]
lappend ekreis Augsburg Baden-Baden Bamberg Bayreuth Berlin Bielefeld Bochum Bonn Bottrop {{Brandenburg an der Havel}} Braunschweig Bremen Chemnitz Coburg Darmstadt Dessau Dortmund Dresden Duisburg Düsseldorf Eisenach Emden Erfurt Essen Flensburg {{Frankenthal (Pfalz)}} {{Frankfurt am Main}} {Frankfurt-Höchst {Frankfurt am Main}} {{Freiburg im Breisgau}} Fürth Gelsenkirchen Gera Hagen {Halle-Neustadt {Halle (Saale)}} Hamburg Hamm Heidelberg Heilbronn {Heiligenbeil Mamonowo} Herne Ingolstadt Jena Kaiserslautern Karlsruhe Kaufbeuren {{Kempten (Allgäu}} Koblenz Krefeld Köln {{Königsberg (Preußen)} Kaliningrad} {{Landau in der Pfalz}} Landshut Leipzig Leverkusen {{Ludwigshafen am Rhein}} Lübeck Magdeburg Mainz Mannheim Memmingen Mönchengladbach {{Mülheim an der Ruhr}} Münster {{Neustadt an der Weinstraße}} Nürnberg Oberhausen {{Offenbach am Main}} {{Oldenburg (Oldb)}} {Opladen Leverkusen} Osnabrück Passau Pforzheim Pirmasens Potsdam Regensburg Rostock {Rostock-Land Rostock} {Roßlau Dessau-Roßlau} Salzgitter Schwabach Schweinfurt Solingen Speyer Stuttgart Suhl {Tilsit {Sowetsk (Kaliningrad)}} Trier Ulm Weimar Wiesbaden Wolfsburg Worms
puts $ekreis
